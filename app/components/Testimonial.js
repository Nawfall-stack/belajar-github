...
const Testimonial = () => {
  return (
    <section className="py-12 bg-gray-50 sm:py-16 lg:py-20  snap-center " id="testimonial">
                  ...
                  <div className="flex-1">
                    ...
                    <blockquote className="flex-1 mt-8">
                      <p className="text-lg leading-relaxed text-gray-900 font-pj">
                        "The design is great and has its own distinctive character—neat and stylish, perfect for those who want a simple design that's full of meaning. Especially the logo, which has a creative shape and is equally
                        captivating. Overall, it's excellent."
                      </p>
                    </blockquote>
                  </div>

                  <div className="flex items-center mt-8">
                    <img className="flex-shrink-0 object-cover rounded-full w-11 h-11" src="./testimonial/testimonial1.jpg" alt="" />
                    <div className="ml-4">
                      <a href="https://www.instagram.com/haidarhanif_674/" target='_blank'>
                        <p className="text-base font-bold text-gray-900 font-pj">Abdurrahman Haidar H</p>
                      </a>
                      <p className="mt-0.5 text-sm font-pj text-gray-600">haidarhanif_674</p>
                    </div>
                  </div>
                </div>
              </div>
